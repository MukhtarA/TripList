...
namespace Trip.Data
{
        ...
        static List<Trip> allTrips = new List<Trip>()
    {
        ...
        new Trip()
        {
            ...
            DateStart = new DateTime(2019,02,22),
            DateEnd = new DateTime(2019,01,30)
        },
        new Trip()
        {
            Id=3,
            ...
            DateStart = new DateTime(2019,01,27),
            DateEnd = new DateTime(2019,01,30)
        },
        new Trip()
        {
        ...
        new Trip()
        {
            ...
            DateStart = new DateTime(2015,01,20),
            DateEnd = new DateTime(2015,01,30)
        },
        new Trip()
        {
            Id=7,
